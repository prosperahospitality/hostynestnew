...
const SiteBudgetStays = () => {
    return (
        <div className='h-screen w-screen bg-white'>
            <div className='h-[20%] flex items-center pl-8'>

                <h1 className='text-[100px] font-bold italic bg-gradient-to-r from-blue-300  to-purple-300 inline-block text-transparent bg-clip-text text-opacity-50'>BUDGET STAYS</h1>

                <div className='flex gap-4 mt-3 bg-white bg-opacity-80 absolute'>
                    <div className='bg-primary w-1 h-[24px] rounded-lg'></div>
                    <h4 className='text-primary text-base italic font-bold'>Hourly Stays Near You</h4>
                </div>
            </div>
...
export default SiteBudgetStays;