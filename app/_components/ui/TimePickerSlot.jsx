...
const TimePickerSlot = ({ selectedDate, handleTimeSelection, showTimePicker, toggleTimePicker }) => {
    ...
    return (
        <div>
            ...
            />
            {showTimePicker && (
                <div className="w-96 left-2 z-50 rounded-2xl mt-6 text-black cursor-pointer absolute text-left bg-white opacity-100" id="headlessui-popover-panel-:ru:" tabIndex="-1" data-headlessui-state="open">
