...
const columns = [
    ...
    {name: "PROPERTY CATEGORY", uid: "property_category", sortable: true},
    {name: "PROPERTY DESCRIPTION", uid: "property_desc", sortable: true},
        ...
        setStatus('')
          ...
          <div className="mt-10 ml-2 mr-2">
            <DataTable data={result} columns={columns}
              statusOptions={statusOptions} statusColorMap={statusColorMap} columnSort="id" columnName={"property_category"} actionsContent={actionsContent} operation="propType" handleOpen={handleOpen} handleClick={handleClick} handleDelete = {handleDelete} handleSubmit = {handleSubmit}/>
          </div>
        </div></>
    );
};